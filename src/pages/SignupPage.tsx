                ...
                <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-lg">
                    <div className="text-center">
                        ...
                        <p className="text-slate-600 mb-4">
                            Un email contenant vos identifiants de connexion a été envoyé à <strong>{formData.email}</strong>
                        </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Input
                                ...
                                required
                                className="h-12 bg-slate-900 border-slate-900 text-white placeholder:text-slate-400"
                            />
                            <Input
                                placeholder="Dupont"
                        ...
                        <div>
                            <Select value={formData.plan} onValueChange={(value) => handleChange('plan', value)}>
                                <SelectTrigger className="h-12 bg-slate-900 border-slate-900 text-white">
